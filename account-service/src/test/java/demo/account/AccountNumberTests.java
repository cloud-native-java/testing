...
public class AccountNumberTests {
    ...
    @Test
    public void createWhenAccountNumberIsMoreThan9CharsShouldThrowException() throws Exception {
        this.thrown.expect(IllegalArgumentException.class);
    ...
    @Test
    public void createWhenAccountNumberIsLessThan9CharsShouldThrowException() throws Exception {
        this.thrown.expect(IllegalArgumentException.class);
        this.thrown.expectMessage("Account Number must be exactly 9 characters");
    ...
    public void equalsAndHashCodeShouldBeBasedOnAccountNumber() throws Exception {
        ...
        assertThat(accountNumber1).isEqualTo(accountNumber1).isEqualTo(accountNumber2).isNotEqualTo(accountNumber3);
    }
}
